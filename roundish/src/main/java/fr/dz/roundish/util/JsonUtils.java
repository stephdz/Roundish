...
public abstract class JsonUtils {
     ...
     * @return
     */
    public static Object[] convertToParameters(final String json, final ServiceMethodDescriptor methodDescriptor) {
     ...
     * @return
     */
    public static <E> E convertToEntity(final String json, final Class<E> clazz) {
     ...
     * @return
     */
    public static String convertExceptionToJson(final Throwable t) {
